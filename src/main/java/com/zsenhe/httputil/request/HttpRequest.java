package com.zsenhe.httputil.request;
...
public class HttpRequest implements AutoCloseable{
    ...
    private HttpRequest header(String k,String v){
        if(headersMap == null) headersMap = new HashMap<>();
        headersMap.put(HttpHeaders.valueOf(k),v);
        return this;
    }

    public HttpRequest header(HttpHeaders httpHeaders,String value){
        return header(httpHeaders.getKey(),value);
    }
